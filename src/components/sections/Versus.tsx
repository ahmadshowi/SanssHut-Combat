...
import { featuredMatchup } from "@/data/stats";
  ...
  return (
    <section id="versus" className="relative section-padding overflow-hidden">
      ...
      <SectionHeading
        ...
        title="1 VS 2 Handicap Match"
        description="Ahmad Showi faces two dangerous opponents in one brutal combat night."
      />
      ...
      <div className="relative grid grid-cols-1 sm:grid-cols-3 items-center gap-10 sm:gap-4">
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            {fighterC && <VersusFighterCard fighter={fighterC} align="right" />}
          </div>
        </FadeIn>
      </div>
      ...
      <FadeIn className="mt-12 mx-auto max-w-3xl">
        <div className="glass-card p-6 sm:p-8">
          ...
          <p className="mt-2 text-center text-sm text-gray-400">
            Showi compared against the main opponent
          </p>
